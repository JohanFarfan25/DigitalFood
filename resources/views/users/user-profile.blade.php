            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="{{ auth()->user()->profile_picture ? asset('storage/' . auth()->user()->profile_picture) : '../assets/img/team-2.jpg' }}" alt="Profile Picture" class="w-100 border-radius-lg shadow-sm">
                    </div>
                </div>
    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-body pt-4 p-5">
                <form action="/user-profile" method="POST" role="form text-left" enctype="multipart/form-data" class="mt-5">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group text-center">
                                <div id="image-preview" class="border p-2 rounded d-inline-block" style="width: 200px; height: 200px; overflow: hidden;">
                                    ...
                                    <img id="preview-image" src="{{ asset('storage/' . auth()->user()->profile_picture) }}" alt="Preview" class="img-fluid" style="max-width: 100%; max-height: 100%;">
                                    @else
