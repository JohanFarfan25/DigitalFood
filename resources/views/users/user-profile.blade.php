            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="{{ auth()->user()->profile_picture ? asset( auth()->user()->profile_picture ) : '../assets/img/team-2.jpg' }}" alt="Profile Picture" class="w-100 border-radius-lg shadow-sm">
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group text-center">
                                <div id="image-preview" class="border p-2 rounded d-inline-block" style="width: 200px; height: 200px; overflow: hidden;">
                                    ...
                                    <img id="preview-image" src="{{ asset( auth()->user()->profile_picture) }}" alt="Preview" class="img-fluid" style="max-width: 100%; max-height: 100%;">
                                    @else
