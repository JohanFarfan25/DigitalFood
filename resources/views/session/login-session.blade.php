            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient ">Welcome Digital Food</h3>
                  <p class="mb-0 text-center">Optimize, control and grow with <br> Digital Food ERP<br></p>
                </div>
                <div class="card-body">
