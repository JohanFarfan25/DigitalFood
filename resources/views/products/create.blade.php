            ...
            <div class="card-body pt-4 p-6 mt-4">
                <form action="/product-create" method="POST" enctype="multipart/form-data" role="form text-left">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="product-expiration_date" class="form-control-label">{{ __('Fecha de Expiración') }}</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="product-purchase_price" class="form-control-label">{{ __('Precio de compra') }}</label>
